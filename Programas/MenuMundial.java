...
public class MenuMundial {
    ...
    public static void main(String[] args) {
        ...
        Scanner sc = new Scanner(System.in); 
                    ...
                    String BG_RED = "\u001B[41m";
                    String BG_GREEN = "\u001B[42m";
                    String BG_DARK_GREEN = "\u001B[48;5;22m";
                    String BG_YELLOW = "\u001B[43m";
                    String BG_BLUE = "\u001B[44m";
                    String BG_DARK_BLUE = "\u001B[48;5;17m";
                    String BG_WHITE = "\u001B[47m";
                    String BG_CYAN = "\u001B[46m";
                    String BG_BROWN = "\u001B[48;5;94m";
                    String BG_DARK_RED = "\u001B[48;5;88m";
                    String BG_ORANGE = "\u001B[48;5;208m";
            ...
            do {
            System.out.println("╔══════════════════════════════════════╗");
            System.out.println("║       MUNDIAL 2026 - SISTEMA         ║");
            System.out.println("╠══════════════════════════════════════╣");
            System.out.println("║ 1. Ver info de los partidos          ║");
            System.out.println("║ 2. Ver tabla de posiciones           ║");
            System.out.println("║ 3. Ver información de país           ║");
            ...
            case 1:
                ...
                System.out.println("╚══════════════════════════════════════╝");
                    ...
                    for (int i = 0; i < grupos.length; i++) {
                        ...
                        String p1 = paises[i][0] + " vs " + paises[i][1];
                        String p2 = paises[i][2] + " vs " + paises[i][3];

                        System.out.println("Grupo " + grupos[i] + " -> " + p1);
                        contador++;
                        ...
                        System.out.println("Grupo " + grupos[i] + " -> "+ p2);
                        contador++;
               ...
               int contador2= 0;
                ...
                for (int i = 0; i < grupos.length; i++) {
                    ...
                    for (int j = 0; j < paises[i].length; j++) {
                        ...
                        System.out.println((j + 1) + ". " + paises[i][j] + " - " + (3 - j) + " pts");
                        contador2++;
            ...
            case 3:
                ...
                System.out.println("\nElige país:");
                for (int i = 0; i < paises[grupoIndex].length; i++) {
                    System.out.println((i + 1) + ". " + paises[grupoIndex][i]);
                }


                int p = sc.nextInt() - 1;

                if (p < 0 || p >= paises[grupoIndex].length) {
                    System.out.println("País inválido.");
                    break;
                }

                String pais = paises[grupoIndex][p];
                ...
                else if (pais.equals("Turquia")) System.out.println("Titulares: Hakan Çalhanoğlu, Cengiz Ünder, Merih Demiral, Burak Yılmaz.");
